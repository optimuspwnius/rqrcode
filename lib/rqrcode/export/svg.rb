  ...
  module Export
    module SVG
      ...
      def as_svg(options={})
        ...
        open_tag = %{<svg version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" xmlns:ev="http://www.w3.org/2001/xml-events" viewBox="0 0 #{dimension} #{dimension}" shape-rendering="#{shape_rendering}" id="#{id}" class="#{klass}" style="width: #{dimension}px; #{style}">}
        close_tag = "</svg>"
